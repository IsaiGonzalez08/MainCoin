  ...
  return (
    ...
    >
      <div className="flex flex-row justify-around">
        ...
        <div className="flex flex-row justify-around gap-4 pt-20">
      ...
      <p className="text-[#FFFFFF] text-xl font-light">
        Descubre los nuevos NFTs mas exclusivos del momento en un solo lugar.
      </p>
      <div className="flex flex-row gap-5 overflow-x-scroll h-[80vh] w-[165vh]">
