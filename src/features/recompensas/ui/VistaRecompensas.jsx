        ...
        <>
            ...
            <div className="w-[160vh] h-[70vh] ml-[10vh] bg-[#FFFFFF] border-y-2 border-[#6F6F6F40]">
                ...
                <div className='bg-[#D9D9D920] w-[158vh] h-[528px] mt-5 ml-[2vh] border-[1.5px] border-[#6F6F6F20] overflow-hidden'>
                    <div className='flex flex-row pl-5 pt-5 gap-5'>
                        <CardUsuarioRecom img="/Img/UserRecompensa1.png" nombre="ShadowFuture" puntos="3 000" dinero="4,200.00"></CardUsuarioRecom>
                        <CardUsuarioRecom img="/Img/filtro9.png" nombre="ShadowFuture" puntos="3 000" dinero="4,200.00"></CardUsuarioRecom>
                        <CardUsuarioRecom img="/Img/filtro10.png" nombre="ShadowFuture" puntos="3 000" dinero="4,200.00"></CardUsuarioRecom>
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-row justify-between border-t-2 border-[#6F6F6F40] w-[160vh] ml-20">
                ...
                <div className="flex flex-row gap-5 pr-32 pt-20">
                    <div className="flex flex-row items-center">
                        <img className="w-7" src="/Icon/Emerald.svg" />
                    ...
                    <div className="flex flex-row">
                        ...
                        <div className="flex flex-col basis-4/5 gap-5">
                            <div className="flex flex-row gap-5">
                                <CardRecompensa img="/Img/filtro1.png" nombre="CatSweet" puntos="200" dinero="298.19"></CardRecompensa>
                                <CardRecompensa img="/Img/filtro2.png" nombre="HoneyBoo" puntos="1 236" dinero="1,278.16"></CardRecompensa>
                                <CardRecompensa img="/Img/filtro3.png" nombre="EstherNova" puntos="450" dinero="457.02"></CardRecompensa>
                            </div>
                            <div className="flex flex-row gap-5">
                                <CardRecompensa img="/Img/filtro4.png" nombre="XelaoNight" puntos="1 273.23" dinero="1,3100.21"></CardRecompensa>
                                <CardRecompensa img="/Img/filtro5.png" nombre="XenoFuture" puntos="5 219.90" dinero="3,028.12"></CardRecompensa>
                                <CardRecompensa img="/Img/filtro6.png" nombre="BunnyBlond" puntos="6 123.28" dinero="4,236.00"></CardRecompensa>
                            </div>
                            <div className="flex flex-row gap-5">
                                <CardRecompensa img="/Img/filtro7.png" nombre="FutureDown" puntos="70" dinero="129.18"></CardRecompensa>
                                <CardRecompensa img="/Img/filtro8.png" nombre="HunterUp" puntos="400" dinero="504.29"></CardRecompensa>
                                <CardRecompensa img="/Img/filtro9.png" nombre="JudgeCoin" puntos="9 125.27" dinero="10,162.00"></CardRecompensa>
                            </div>
